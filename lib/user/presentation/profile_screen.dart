  ...
  Widget _buildMenuItem({
    ...
    return ListTile(
      ...
      leading: Container(
        ...
        child: Icon(
          icon,
          color: isLogout ? Colors.red : themeColor,
        ),
      ),
      title: Text(
        title,
        ...
        child: Container(
          ...
          child: const Column(
            ...
            children: [
              ...
              Text(
                "Your refund request will be processed within 3-5 working days.\n\nFor any issue regarding ticket cancellation or payment refund, please contact support.",
                style: TextStyle(
                  fontSize: 16,
